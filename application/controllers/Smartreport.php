	...
	public function index()
	{
		...
		if ($this->session->userdata('userid') == '') {
			...
			//	$milege_per_hour = ($total_fuel_consume / $tot_trip1);
				$avg_moving_fl_cunsume = ($total_fuel_consume && $tot_move1 && $consume_count) ? round(($total_fuel_consume/$tot_move1)/$consume_count,1) : '';
				$moving_fl_cunsume = ($total_fuel_consume && $tot_move1) ? round(($total_fuel_consume/$tot_move1),1) : '';
				$not_moving_fl_cunsume = ($total_fuel_consume && $tot_idle1) ? round(($total_fuel_consume/$tot_idle1),1) : '';
