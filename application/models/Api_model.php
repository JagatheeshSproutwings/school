...
public function checkuser_admin($username,$password)
	...
	{		
		 $query=$this->db->query("SELECT u.userid,u.firstname,u.username,u.companyname,u.mobilenumber,u.email,u.roleid,u.client_id,u.dealer_id,u.subdealer_id,u.push_code,u.time_zone,tz.timezone_mins FROM usertbl u LEFT JOIN time_zone tz ON tz.timezone_id=u.time_zone  WHERE status=1 AND roleid='15' AND userid=$userid" );
