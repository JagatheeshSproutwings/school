...
{		
	$query = $this->db->query("SELECT stu.student_name,stu.student_rollno,sc.class_name,ss.section_name FROM sch_student stu INNER JOIN sch_class sc ON sc.class_id = stu.class_id INNER JOIN sch_section ss ON ss.section_id = stu.section_id WHERE 
