...
class Api_model extends CI_model
{
   function __construct()
    ...
    public function livetrackvehiclelist($userid,$shift_type)
	{		
         ...
         srt.route_geo_end_id,srt.route_starttime,srt.route_endtime,v.vehiclename,v.deviceimei,v.client_id
          ...
          INNER JOIN sch_location_list l1 ON l1.Location_Id=srt.route_geo_end_id WHERE ss.parent_id =$userid AND sr.shift_type=$shift_type GROUP BY ss.student_id" );
