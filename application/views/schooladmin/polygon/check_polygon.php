        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">CHECK POLYGON</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo base_url();?>dashboard/">Home</a></li>
                                <li class="breadcrumb-item active"> CHECK POLYGON</li>
                            </ol>
                        </div>
                    </div>
                </div>
                <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
                    <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                        <div class="btn-group" role="group">
                            <button class="btn btn-outline-primary" id="showuser" type="button"> <i class="feather icon-user-plus icon-left"></i> Check  polygon </button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12 adduser">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Check polygon </h4> <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal form-simple" id="checkpolygonform" method="post" novalidate enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                                                    <h5 class="text-bold-600">Check polygon Details</h4>
                                              </div>
                                ...
                                <table  id="vehiclelist" class="table table-striped table-bordered dataex-res-configuration">
                                    <thead class="bg-primary">
                                        <tr>
                                            ...
                                            <th>Vehicle Name </th>
                                            <th>Polygon Name </th>  
                                            <th>Vehicle In datetime </th>
                                            <th>Polygon Out Datetime </th>                                            
                                            <th>Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$list->in_datetime;?> </td>
                                            <td><?=$list->out_datetime;?></td>                                        
                                                                                        
                                            <td>  <a href="#" class="edit"  id="<?php echo $list->id;?>"><i class="fa fa-trash" aria-hidden="true"></i></a><!--   &nbsp;&nbsp; <a href="javascript:delete_data('<?php echo $list->id;?>')"><i class="fa fa-trash " aria-hidden="true"></i></a>
...
<script>    
 $('#vehicle_id').change(function(){
  ...
  $("#checkpolygonform").submit(function(e) {
              ...
              var form = $(this);
                ...
                console.log(form.serialize());
                  var url = '<?php echo site_url('polygon/save_check_polygon');?>';
                  $.ajax({
                       type: "POST",
                       url: url,
