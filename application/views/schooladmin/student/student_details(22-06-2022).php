                    ...
                    <div class="row">
                        <div class="col-md-12 adduser" style="display:none">
                            <div class="card">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        <label for="route_id" class="required">Route Name<span class="error">&nbsp;*</span></label>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        <label for="stop_id" class="required">Stop Name<span class="error">&nbsp;*</span></label>
                                        <select id='stop_id' name="stop_id" class="form-control">
