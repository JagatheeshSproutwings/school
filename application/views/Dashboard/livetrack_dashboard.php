    ...
    <div class="card-content">
      <div class="card-body">
        <div class="card-text">
          ...
          <div class="modal fade text-left" id="warning" tabindex="-1" role="dialog" aria-labelledby="myModalLabel12" style="display: none;" aria-hidden="true">
									  <div class="modal-dialog" role="document">
										<div class="modal-content">
										  <div class="modal-header bg-warning white">
                        <h4 class="modal-title" id="myModalLabel12"><i class="fa fa-tree"></i> Student Details</h4>
        ...
        <section class="wrapper" style="height: 85vh !important">
          <div class="market-updates">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12" style='padding-top: 5px !important;'>
              <h2 style='margin: 15px !important;'>Live Track Dashboard&nbsp;<li class="fa fa-dashboard"></li>
              </h2>
            </div>
                      ...
                      <tr>
                        ...
                        <td><?php $ign_q = $this->db->query("SELECT Location_short_name FROM location_list WHERE Location_id='" . $livedetails[$i]['liveroute_details']['route_startid'] . "'");
                          ...
                          <?php
                              ...
                              $darrival_session_datetime =  substr($darrival_session, 0, -2);
                              $darrival_session_datetime = date("Y-m-d H:i:s", strtotime($darrival_session_datetime));
                              $darrival_session = $livedetails[$i]['liveroute_details']['route_planstart_time'];
                              $sarrival_time = date("h:i:s A", strtotime($livedetails[$i]['liveroute_details']['route_exitime']));
                              $sarrival_datetime = date("Y-m-d H:i:s", strtotime($livedetails[$i]['liveroute_details']['route_exitime']));
                  
                              $time1 = new DateTime($darrival_session_datetime);
                              $time2 = new DateTime($sarrival_datetime);
                          ...
                          <span style="color:#db5046;">Exit Delay:<?php if ($darrival_session > $sarrival_time) {
                                                                    echo "--";
                                                                  } else {
                                                                    echo $timediff->format(' %i Minutes');
                                                                  } ?></span><br>
                          <?php if ($darrival_session > $sarrival_time || $route_startmin < 10) { ?><span style="border:1px solid green;background:green;color:white;">Status:<?php echo "Ontime";                                                                                                                                                                                                                                              } ?></span><br>
                        </td>
                        <?php
                        ...
                        ?>
                          <td>
                            ...
                            <span>ETA:<?php if ($s_list['stopentry_time']) {
                                        echo "<span style ='color:red;'>reach</span>";
                                      } else {
                                        echo $s_list['stop_ept_time'];
                                      } ?></span><br>
                            <span>P.Entry:<?php echo $s_list['stopplaned_entry'] ?></span><br>
                            <span>P.Exit :<?php echo $s_list['stopplaned_exit'] ?></span><br>
                            <span>A.Entry:<?php if ($ac_starttime == '05:30 AM') {
                                          } else {
                                            echo  $ac_starttime;
                                          } ?></span><br>
                            <span>A.Exit :<?php if ($ac_endtime == '05:30 AM') {
                                          } else {
                                            echo  $ac_endtime;
                                          } ?></span><br>
                            <?php
                            ...
                            ?>
                            <span style="color:#db5046;">Entry Delay:<?php if ($time3 > $time4) {
                                                                        echo "-";
                                                                      } else {
                                                                        if ($sarrival_stop == '05:30:00') {
                                                                          echo "-";
                                                                        } else {
                                                                          echo $stop_entrymin . 'mins';
                                                                        }
                                                                      } ?></span><br>

                            <span style="color:#db5046;">Exit Delay:<?php if ($time6 > $time5) {
                                                                      echo "-";
                                                                    } else {
                                                                      if ($dispatch_stop == '05:30:00') {
                                                                        echo "-";
                                                                      } else {
                                                                        echo $stop_exitmin . 'mins';
                                                                      }
                                                                    } ?></span><br>



                            <span><?php if ($stop_entrymin != '') {
                                    if ($stop_entrymin < 10 || $time6 > $time5) { ?><span style="border:1px solid green;background:green;color:white;">Status:<?php echo "Ontime";
                                                                                                                                                                                    } else { ?><span style="border:1px solid red;background:red;color:white;">Status:<?php echo "Late";
                                                                                                                                                                                                                                                                                      }
                                                                                                                                                                                                                                                                                    } else { ?><span style="border:1px solid yellow;background:yellow;color:black;">Status:<?php echo "Not Reached";
                                                                                                                                                                                                                                                                                                                                                                                              } ?></span><br>
                                    <button type="button" class="btn btn-outline-warning block btn-lg" onclick="myFunction(<?php echo $s_list['stop_geo_id']; ?>)" data-toggle="modal" data-target="#warning">
                                    Attendance
                                  </button>
                          </td>
                        <?php } ?>
                        ...
                        <td><?php $ign_eq = $this->db->query("SELECT Location_short_name FROM location_list WHERE Location_id='" . $livedetails[$i]['liveroute_details']['route_endid'] . "'");
                          ...
                          <span>ETA:<?php if ($livedetails[$i]['liveroute_details']['route_entry_time']) {
                                      echo "<span style ='color:red;'>reach</span>";
                                    } else {
                                      echo $livedetails[$i]['liveroute_details']['routeend_exptime'];
                                    } ?></span><br>

                          <?php

                          $darrival_session1 = $livedetails[$i]['liveroute_details']['route_planend_time'];
                          $darrival_session_datetime1 =  substr($darrival_session, 0, -2);
                          $darrival_session_datetime1 = date("Y-m-d H:i:s", strtotime($darrival_session_datetime1));
                          $sarrival_time1 = date("h:i:s A", strtotime($livedetails[$i]['liveroute_details']['route_entry_time']));
                          $sarrival_datetime1 = date("Y-m-d H:i:s", strtotime($livedetails[$i]['liveroute_details']['route_exitime']));
                       
                          $time1 = new DateTime($darrival_session_datetime1);
                          $time2 = new DateTime($sarrival_datetime1);
                          $timediff = $time1->diff($time2);
                          ...
                          <span>A.Entry:<?php if ($acroute_endtime == '05:30 AM') {
                                          echo "--";
                                        } else {
                                          echo $acroute_endtime;
                                        } ?></span><br>

                          <span style="color:#db5046;">Entry Delay:<?php if ($livedetails[$i]['liveroute_details']['route_entry_time']) {
                                                                      if ($darrival_session1 > $sarrival_time1) {
                                                                        echo "--";
                                                                      } else echo $route_endmin . 'mins';
                                                                    } ?></span><br>

                          <?php if ($acroute_endtime != '05:30 AM') {
                            if ($route_endmin < 10 || $darrival_session1 > $sarrival_time1) { ?><span style="border:1px solid green;background:green;color:white;">Status:<?php echo "Ontime";
                                                                                                                                                                                                          } else { ?><span style="border:1px solid red;background:red;color:white;">Status:<?php echo "Late";
                                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                          } else { ?><span style="border:1px solid yellow;background:yellow;color:black;">Status:<?php echo "Not Reached";
                                                                                                                                                                                                                                                                                                                                                                                                                    } ?></span>
  ...
  function myFunction(stop_geo_id) {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        $('#student_tbody').empty().append(trHTML);
      }
    });
