        ...
        <div class="row">
          <div class="col-12 pt-2 pb-2 border-bottom-blue-grey border-bottom-lighten-5">
            <div class="info-time-tracking-title d-flex justify-content-between align-items-center">
              <h4 class="pl-2 mb-0 title-info-time-heading text-bold-500">Parking Report1</h4>
              <span class="pr-2">
...
<script type="text/javascript">
    ...
    var map = L.map('park_map').setView(defaultCoords,6);
   ...
   console.log(startCoords);
                          ...
                          $.ajax({
                                url: '<?php echo site_url('/Genericreport/get_address/'); ?>',
                                type: 'GET',
                                dataType:'json',
                                data: {
                                    Lattitute: data.s_lat,
                                    Longitute: data.s_lng
                                },
                                cache: false,
                                ...
                                //     });
                                     ...
                                     var marker_content = response.address;
