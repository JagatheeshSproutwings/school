        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">Engine RPM Report</h3>
                 ...
                 ?>
                            <thead>
                                        ...
                                        <tr class="trip_tr">
                                              ...
                                              <th colspan="4"><b>Vehicle:</b> <?=$vlist['vehicle_name'];?></th>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $count_sno = 1;
                                   // print_r($vlist['normal_rpm']);
                                    foreach($vlist['rpm_data'] as $list)
                                       {  

                                            ?>
                                            <tr>
                                                <td><?=$list->rpm_status;?></td>
                                ...
                                <tr>
                                    <?php //$total_value = ?>
                                      ...
                                      <th colspan="3"></th>
                                      <th rowspan ="5" class="trip_tr"><b>Total Load Duration:</b> <?php echo gmdate("H:i:s", $total_value*60);?></th>
