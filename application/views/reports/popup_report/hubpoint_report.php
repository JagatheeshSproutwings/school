  <div class="modal fade text-left" style="background:radial-gradient(black, transparent)" id="hub_report" tabindex="-1" role="dialog" aria-labelledby="myModalLabel12" aria-hidden="true">
          <form action="<?php echo site_url('Genericreport/hubpoint_report');?>" method="post" target="_blank">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-warning white">
                    <h4 class="modal-title" id="myModalLabel12"><i class="fa fa-tree"></i>Hubpoint report</h4>
                    ...
                    <div class="row">
                       ...
                       <?php   } ?>
                        ...
                        <select name="geolocation" class="select2 form-control">
                            ...
                            <?php foreach ($hublocation as $list) { ?>
