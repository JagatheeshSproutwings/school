          ...
          iconSize:  [35, 35],
                        ...
                        //  console.log(stop_latlng.length);
                         ...
                         for (let i = 0; i < stop_latlng.length; i++) {
                           ...
                           var stoppopup = '<div style="width: 200px;"><b style="color:green">No of Students: '+stop_latlng[i].student_count+'</b> &emsp;<a href="javascript:studentlist('+stop_latlng[i].stop_latlng.stop_id+')"  style="color:red">Show</a><br><b>Start Point:</b> '+stop_latlng[i].stop_latlng.stop_name+'<br></div>';
