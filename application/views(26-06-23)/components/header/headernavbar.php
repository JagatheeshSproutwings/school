      ...
      <div class="navbar-wrapper">
        <div class="navbar-header expanded" style="width:240px !important;">
          <ul class="nav navbar-nav flex-row">
            ...
            <?php }else{ ?>
                <li class="nav-item mr-auto"><a class="navbar-brand" href="<?php echo base_url('dashboard/schooladmin');?>">
                <img class="brand-logo" alt="stack admin logo" src="<?php echo base_url();?>assets/dist/img/logo_s_twings.png" style="height: 100%; width: 78%;margin-top:-20px;" alt="school">
            </a></li>
            <?php } ?>
