...
<div class="row">
		...
		<div class="col-md-12 col-sm-12">
			<div class="card text-white box-shadow-0">
				<div class="card-header">
					<h4 class="card-title text-center warning">Live Track Dashboard</h4>
    ...
    color: white;"></span></div>
          ...
          <table id="livetrack" class="table table-bordered table-striped" >
          <thead>
             <tr>
...
?>
               ...
               <?php if($acroute_endtime!='05:30 AM'){ if($route_endmin<10 || $darrival_time1 > $sarrival_time1){?><span style="border:1px solid green;background:green;color:white;">Status:<?php echo "Ontime";}else{?><span style="border:1px solid red;background:red;color:white;">Status:<?php echo "Late";} }else{?><span style="border:1px solid yellow;background:yellow;color:black;">Status:<?php echo "Not Reached";}?></span>
                        ...
                        <?php
          $data = array(
            'from_date'=>$livedetails[$i]['liveroute_details']['route_exitime'],
            'to_date'=>$livedetails[$i]['liveroute_details']['route_entry_time'],
            'vehicleid'=>$livedetails[$i]['liveroute_details']['vehicle_id'],
            'route_id'=>$livedetails[$i]['liveroute_details']['route_id']
        );
          $alldata = json_encode($data);
          $alldata = urlencode($alldata);?>
               <td><b>Map view</b>
              <a href="<?php echo base_url('Livetrack/playback_details?data='.$alldata);?>" target="_blank">
