...
<body class="vertical-layout vertical-menu-modern content-left-sidebar email-application fixed-navbar menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="content-left-sidebar">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                ...
                                <table id="totaldevices" class="table table-striped table-bordered">
                            ...
                            foreach($data as $value){ ?>
                                <tr>
                                    ...
                                    <td>
                                          <input type="checkbox" class="chkproject" name="check"  id="chkproject" value="<?php echo $value->vehicleid ?>">
                                        </td>
                            ...
                            ?>
                                ...
                                <a href="javascript:activate()" class="btn btn-primary">Activate</a>
                                <a href="javascript:deactive()" class="btn btn-danger">Deactivate</a>
                              </div>                
                            </div>
                        </div>
                    </div>
    ...
    function activate(){
            ...
            $.ajax({
               type:"POST",
               url:"<?php echo site_url();?>/Dashboard/activate_vehicle",
               data:{
                   id:ids
               },
        ...
        function deactive(){
            ...
            $.ajax({
               type:"POST",
               url:"<?php echo site_url();?>/Dashboard/deactivate_vehicle",
               data:{
                   id:ids
               },
               success:function(response){
