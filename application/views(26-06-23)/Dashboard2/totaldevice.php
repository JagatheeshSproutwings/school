                            ...
                            foreach($data as $value){ ?>
                                <tr>
                                    <td><?php echo $i; ?></td>
                                        ...
                                        //  if($role==3)
                                        //  {
                                            $dealer_query = $this->db->query("SELECT dealer_name FROM dealertbl WHERE dealer_id = '".$value->dealer_id."'");
                                            $dealer_data = $dealer_query->row();
                                        //  }?>
                                         <!-- else
                                         {
                                            $dealer_query = $this->db->query("SELECT subdealer_name as dealer_name FROM subdealertbl WHERE subdealer_id = '".$subdealer_id."'");
                                         }
                                       -->
