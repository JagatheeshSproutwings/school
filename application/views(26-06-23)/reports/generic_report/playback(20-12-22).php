                                           ...
                                           <select class="select2 form-control" id="vehicle_id" name="vehicle_id">
                                               ...
                                               <?php if ($vehicle_details) {
                                                foreach ($vehicle_details as $dlist) { ?>
                                                     <option value="<?php echo $dlist->deviceimei;?>"><?php echo $dlist->vehiclename;?></option>
                                            <?php  }
                                               } ?>
                                          </select>
...
// var tileUrl = 'http://{s}.google.com/vt/lyrs=m&x={x}&y={y}&z={z}',
...
var popup = L.popup()
.setLatLng(e.latlng)
.setContent('Latlng:'+e.latlng.lat+','+e.latlng.lng)
.openOn(map);
