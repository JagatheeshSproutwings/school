<body class="vertical-layout vertical-menu-modern content-left-sidebar email-application fixed-navbar menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="content-left-sidebar">
    ...
    <div class="custom-control custom-checkbox exebtm">
            <input type="checkbox" value="1" <?php echo $executive_access->triptime == '1' ? 'checked' : '' ?> class="custom-control-input" name="triptime" id="triptime">
            <label class="custom-control-label" for="triptime">Trip time, hh:mm:ss</label>
        </div>
        <div class="custom-control custom-checkbox exebtm">
            <input type="checkbox" value="1" <?php echo $executive_access->triptime_percentagerpt == '1' ? 'checked' : '' ?> class="custom-control-input" name="triptime_percentagerpt" id="triptime_percentagerpt">
            <label class="custom-control-label" for="triptime_percentagerpt">Trip time, % of the report period</label>
        </div>
        ...
        <!-- <div class="custom-control custom-checkbox exebtm">
            <input type="checkbox" value="1" <?php echo $executive_access->actime_hhmmss == '1' ? 'checked' : '' ?> class="custom-control-input" name="actime_hhmmss" id="actime_hhmmss">
            <label class="custom-control-label" for="actime_hhmmss">AC time, hh:mm:ss</label>
        </div>
        <div class="custom-control custom-checkbox exebtm">
            <input type="checkbox" value="1" <?php echo $executive_access->actime_percentage == '1' ? 'checked' : '' ?> class="custom-control-input" name="actime_percentage" id="actime_percentage">
            <label class="custom-control-label" for="actime_percentage">AC time, % of the report period</label>
        </div> -->
        ...
        <div class="custom-control custom-checkbox exebtm">
            ...
            <label class="custom-control-label" for="rpm_opr_hhmmss">Engine operation Idle time , hour:min:sec</label>
        </div>
        <div class="custom-control custom-checkbox exebtm">
            ...
            <label class="custom-control-label" for="rpm_engine_opr_percentage">Engine operation Idle time, % of engine operation time</label>
        </div>
                <hr>
                            ...
                            <thead>
                                 <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="greenclr <?php echo $executive_access->triptime == '0' ? 'displaynone' : '' ?>">Trip time, hh:mm:ss</td>
                                            <td class="greenclr <?php echo $executive_access->triptime_percentagerpt == '0' ? 'displaynone' : '' ?>">Trip time, % of the report period</td>
                                            ...
                                            <td class="greenclr <?php echo $executive_access->actime_hhmmss == '0' ? 'displaynone' : '' ?>">AC time, hh:mm:ss</td>
                                            <td class="greenclr <?php echo $executive_access->actime_percentage == '0' ? 'displaynone' : '' ?>">AC  time, % of the report period</td>
                            ...
                            <tbody>
                                 ...
                                 //   print_r($consolidate_data);
                                    ...
                                    {?>
                                          ...
                                          <td class="<?= $executive_access->triptime == '0' ? 'displaynone' : '' ?>"><?=$value['trip'];?></td>
                                          <td class="<?= $executive_access->triptime_percentagerpt == '0' ? 'displaynone' : '' ?>"><?=$value['trip_period'].'%';?></td>
                                          ...
                                          <td class="<?= $executive_access->actime_hhmmss == '0' ? 'displaynone' : '' ?>"><?=$value['ac'];?></td>
                                          <td class="<?= $executive_access->actime_percentage == '0' ? 'displaynone' : '' ?>"><?=$value['ac_period'].'%';?></td>
                                          <td class="<?= $executive_access->rpm_opr_time_hhmmss == '0' ? 'displaynone' : '' ?>"><?=$value['tot_rpm'].' ('.$value['tot_hrpm'].')';?></td>
