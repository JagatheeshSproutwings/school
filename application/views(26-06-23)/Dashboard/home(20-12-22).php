...
<div class="card box-shadow-0 border-warning">
        ...
        <div class="card-header card-head-inverse bg-warning">
         ...
         <label for="basicInput3">Type</label>
          ...
          <div class="col-xl-2 col-lg-4 col-sm-12 fromdate">
          <fieldset class="form-group">
          ...
          <div class="col-xl-2 col-lg-4 col-md-2 col-sm-12 todate">
          <fieldset class="form-group">
          ...
          <div class="col-xl-2 col-lg-4 col-sm-12 searchbtn">
          <fieldset class="form-group">
  ...
  //  alert(vehicle);
   ...
   $('.high_running').show();
    ...
    L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png',{maxZoom:20}).addTo(map);
        // http://198.204.245.190/osm/{z}/{x}/{y}.png
