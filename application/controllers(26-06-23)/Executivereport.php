				...
				{	
                   // print_r($list);exit;
                    ...
                    $all_rpm = $this->Executivereport_model->consolidate_allrpmday($list,$dd);
						...
						$day_data[$dd]=array(
                                                    'distance'=>round($yesterday_distance->distance_km,1),
                                                    ...
                                                    'ign'=>$tot_move,
                                                    'ac'=>$tot_ac,
                                                    'park_period'=>round($park_period,1),
                                                    'trip_period'=>round($trip_period,1),
                                                    'running_period'=>round($running_period,1),
                                                    'idle_period'=>round($idle_period,1),
                                                    'ac_period'=>round($ac_period,1),
                                                     'tot_rpm'=>$tot_rpm,
                                                     'tot_hrpm'=>$tot_hrpm,
                                                    'tot_normalrpm'=>$tot_normalrpm,
                                                    'tot_loadrpm'=>$tot_loadrpm,
                                                    'tot_idlerpm'=>$tot_idlerpm,
                                                     'tot_rpm_period'=>round($tot_rpm_period,1),
                                                     'normalrpm_period'=>round($normalrpm_period,1),
                                                    'loadrpm_period'=>round($loadrpm_period,1),
                                                    'idlerpm_period'=>round($idlerpm_period,1),
