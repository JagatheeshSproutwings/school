...
class Cron_ctrl extends CI_Controller
{
	...
	public function cron_distance_old()
	{
		echo "CRON DISTANCE EXECUTION START";
		$timezone = $this->input->get('timezone');
		 ($timezone !='qatar' ) ? date_default_timezone_set("Asia/Calcutta") : date_default_timezone_set("Asia/qatar");
		$timezone = ($timezone =='india' ) ? 0 : 1;
		$timezone_hours = ($timezone == 1) ? 180 : 330;
