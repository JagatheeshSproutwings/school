...
INSERT INTO `sch_class` VALUES (2,371,470,'2nd std',470,'2022-05-20 14:26:26',470,'2022-05-20 15:39:53',1);
...
--
-- Table structure for table `sch_parent`
--

DROP TABLE IF EXISTS `sch_parent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sch_parent` (
...
--
-- Dumping data for table `sch_parent`
--

LOCK TABLES `sch_parent` WRITE;
/*!40000 ALTER TABLE `sch_parent` DISABLE KEYS */;
/*!40000 ALTER TABLE `sch_parent` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sch_route_stops`
--

DROP TABLE IF EXISTS `sch_route_stops`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sch_route_stops` (
...
--
-- Dumping data for table `sch_route_stops`
--

LOCK TABLES `sch_route_stops` WRITE;
/*!40000 ALTER TABLE `sch_route_stops` DISABLE KEYS */;
/*!40000 ALTER TABLE `sch_route_stops` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `sch_section`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `sch_section`
--

LOCK TABLES `sch_section` WRITE;
/*!40000 ALTER TABLE `sch_section` DISABLE KEYS */;
INSERT INTO `sch_section` VALUES (1,'abc',470,'2022-05-23 12:53:57',470,'2022-05-23 13:41:47',2,371,1),(2,'B',470,'2022-05-23 12:54:49',0,'0000-00-00 00:00:00',2,371,1);
/*!40000 ALTER TABLE `sch_section` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-05-25 14:22:01
